...
class OrderSearchRequest(BaseModel):
    ...
    since: Optional[str] = Field(default=None, description="ISO UTC with millis, e.g. 2026-01-01T00:00:00.000Z")
    until: Optional[str] = Field(default=None, description="ISO UTC with millis, e.g. 2026-12-31T23:59:59.000Z")
